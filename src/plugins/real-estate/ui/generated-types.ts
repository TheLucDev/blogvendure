...
export type MutationAddRealEstateArgs = {
...
export type RealEstateAddInput = {
...
export namespace RealEstateCustomFields {
  export type Fragment = RealEstateCustomFieldsFragment;
}

export namespace UpdateRealEstate {
  export type Variables = UpdateRealEstateMutationVariables;
  export type Mutation = UpdateRealEstateMutation;
  export type UpdateRealEstate = UpdateRealEstateMutation['updateRealEstate'];
}

export namespace CreateRealEstate {
  export type Variables = CreateRealEstateMutationVariables;
  export type Mutation = CreateRealEstateMutation;
...
export namespace GetRealEstate {
  ...
  export type RealEstate = (NonNullable<GetRealEstateQuery['RealEstate']>);
}

export type RealEstateCustomFieldsFragment = (
  { __typename?: 'RealEstate' }
  & Pick<RealEstate, 'id' | 'projectName' | 'descriptions' | 'price' | 'address' | 'createdAt' | 'updatedAt'>
);
...
export type GetRealEstateQueryVariables = Exact<{
  id: Scalars['ID'];
}>;
