...
// import { AddBlogToGroupDialogComponent } from '../add-customer-to-group-dialog/add-customer-to-group-dialog.component';
// import { BlogGroupDetailDialogComponent } from '../customer-group-detail-dialog/customer-group-detail-dialog.component';
// import { BlogGroupFetchParams } from '../customer-group-member-list/customer-group-member-list.component';

// @Component({
//     selector: 'vdr-group-list',
//     templateUrl: './group-list.component.html',
//     styleUrls: ['./group-list.component.scss'],
//     changeDetection: ChangeDetectionStrategy.OnPush,
// })
// export class BlogGroupListComponent
//     extends BaseListComponent<
//         GetBlogGroupsQuery,
//         GetBlogGroupsQuery['blogGroups']['items'][number]
//     >
//     implements OnInit
// {
//     searchTerm = new FormControl('');
//     activeGroup$: Observable<GetBlogGroups.Items | undefined>;
//     activeGroupId: string | undefined;
//     listIsEmpty$: Observable<boolean>;
//     members$: Observable<GetBlogGroupWith.Items[]>;
//     membersTotal$: Observable<number>;
//     selectedBlogIds: string[] = [];
//     fetchGroupBlog$ = new BehaviorSubject<BlogGroupFetchParams>({
//         skip: 0,
//         take: 0,
//         filterTerm: '',
//     });
//     private refreshActiveGroupList$ = new BehaviorSubject<void>(undefined);
...
//         super.setQueryFn(
//             (...args: any[]) =>
//                 this.dataService.blog.getCustomerGroupList(...args).refetchOnChannelChange(),
